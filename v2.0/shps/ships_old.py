...
class Ship(pygame.sprite.Sprite):
    ...
    def set_vertical(self, vertical:bool):
        ...
        '''
        This function is used to characterise an instantiation of Ship as being vertical
        '''
    ...
    def set_gridpos(self, grid_pos):
        ...
        Returns
        -------
        Referencing the dictionary of the coordinates, the Ship.set_vertical method and the Ship.size attribute we create
